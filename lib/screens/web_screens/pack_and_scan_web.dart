...
class PackAndScanWeb extends StatefulWidget {
  const PackAndScanWeb({Key? key, required this.apiKey}) : super(key: key);

  final String apiKey;

  @override
  State<PackAndScanWeb> createState() => _PackAndScanWebState();
}

class _PackAndScanWebState extends State<PackAndScanWeb> {
        ...
        await Future.delayed(const Duration(milliseconds: 100), () async {
          if (eanOrOrderSelected == 'Order Number') {
            await getOrdersForPackAndScan(
              type: '',
              ean: '',
              orderNumber: barcodeController.text.toString(),
            );
          } else {
            await getOrdersForPackAndScan(
              type: selectedPicklist,
              ean: barcodeController.text.toString(),
              orderNumber: '',
            );
          }
        }).whenComplete(() async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: isPrinterNotSelected == true
          ? SizedBox(
              height: size.height,
              width: size.width,
              child: const Center(
                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton(
                                  ...
                                  onChanged: (Object? newValue) {
                                    setState(() {
                                      eanOrOrderSelected = newValue as String;
                                    });
                              ...
                              child: Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton(
                                    ...
                                    onChanged: (Object? newValue) {
                                      setState(() {
                                        selectedPicklist = newValue as String;
                                      });
                              ...
                              child: TextFormField(
                                ...
                                onChanged: (_) {
                                  ...
                                  if (barcodeController.text
                                          .toString()
                                          .isNotEmpty &&
                                      barcodeController.text.toString().length >
                                          4) {
                            ...
                            : Padding(
                                ...
                                child: Center(
                                  child: eanOrOrderSelected == 'Barcode'
                                      ? selectedPicklist == 'MSMQW'
                                          ? (parseToInt(orderListForPackAndScanBarcodeMSMQW[0][0].totalSkUs.toString()) ==
                                                  parseToInt(
                                                      orderListForPackAndScanBarcodeMSMQW[0][0]
                                                          .pickedSkUs
                                                          .toString()))
                                              ? Table(
                                                                  ...
                                                                  TableCell(
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            SelectableText(
                                                                          orderListForPackAndScanBarcodeMSMQW[0][index]
                                                                              .qtyToPick,
                                                                          style: const TextStyle(
                                                                              fontSize: 25,
                                                                              fontWeight: FontWeight.bold),
                                                                    ...
                                                                    children: [
                                                                      Row(
                                                                        children: [
                                                                          ...
                                                                          Flexible(
                                                                            child:
                                                                                SelectableText(
                                                                              orderListForPackAndScan[0].title,
                                                                              style: const TextStyle(
                                                                                overflow: TextOverflow.visible,
                                                                              ),
                                                                            ),
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          ...
                                                                          SelectableText(
                                                                            orderListForPackAndScan[0].orderNumber,
                                                                          )
                                                                        ],
                                                                      ),
                                                                      const SizedBox(
                                                            ...
                                                            child: SizedBox(
                                                              ...
                                                              child: Center(
                                                                child: orderListForPackAndScan[
                                                                    ...
                                                                    : ImageNetwork(
                                                                        image: orderListForPackAndScan[0]
                                                                            .url,
                                                                        height:
                                                                            140,
                                                                        width:
                                      ...
                                      : selectedPicklist == 'SIW'
                                          ...
                                          : Table(border: TableBorder.all(color: Colors.black, width: 1), columnWidths: <int, TableColumnWidth>{
                                              0: FixedColumnWidth(
                                                  size.width * .55),
                                              1: FixedColumnWidth(
                                                  size.width * .1),
  ...
  Future<void> print(String url) async {
    ...
    try {
      ...
      //     printer: printers.first, onLayout: (_) => base64Decode(url));
  ...
  Future<void> sendPrintJob({
    ...
    /// IMPLEMENT LABEL PDF URL IN THE BODY

    var body = json.encode({
      "printerId": printerId,
      "title": orderNumber,
      "contentType": "pdf_uri",
      "content": "https://easypost-files.s3-us-west-2.amazonaws.com/files/postage_label/20230130/a37bf40431764d0a9adfc5904b98ddae.pdf",
      "source": "Pack and Scan"
    });
