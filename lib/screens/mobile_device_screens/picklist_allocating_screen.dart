...
class PicklistAllocatingScreen extends StatefulWidget {
  const PicklistAllocatingScreen({
    Key? key,
  ...
  @override
  State<PicklistAllocatingScreen> createState() =>
      _PicklistAllocatingScreenState();
}

class _PicklistAllocatingScreenState extends State<PicklistAllocatingScreen> {
                    ...
                    children: [
                      Table(
                        ...
                        columnWidths: <int, TableColumnWidth>{
                          0: FixedColumnWidth(size.width * .3),
                          1: FixedColumnWidth(size.width * .4),
